...
function(generate_pkgconfig TARGET DESCRIPTION)
  ...
  if (TD_INSTALL_VERSIONED)
    set(PKGCONFIG_INCLUDEDIR "${PKGCONFIG_INCLUDEDIR}/${PROJECT_NAME}${PROJECT_VERSION}")
  endif()
  ...
  if (TD_INSTALL_VERSIONED)
    set(PKGCONFIG_LIBDIR "${PKGCONFIG_LIBDIR}/${PROJECT_NAME}${PROJECT_VERSION}")
  endif()

  file(MAKE_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/pkgconfig")
  set(PKGCONFIG_NAME "${TARGET}")
  if (TD_INSTALL_VERSIONED)
    set(PKGCONFIG_NAME "${PKGCONFIG_NAME}${PROJECT_VERSION}")
  endif()
  file(GENERATE OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/pkgconfig/${PKGCONFIG_NAME}.pc" CONTENT
"prefix=${PREFIX}
...
${REQUIRES}${LIBRARIES}")
  ...
  if (LIBRARY_TYPE STREQUAL "STATIC_LIBRARY" OR LIBRARY_TYPE STREQUAL "SHARED_LIBRARY")
    install(FILES "${CMAKE_CURRENT_BINARY_DIR}/pkgconfig/${PKGCONFIG_NAME}.pc" DESTINATION "${CMAKE_INSTALL_LIBDIR}/pkgconfig")
